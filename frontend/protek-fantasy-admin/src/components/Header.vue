                    ...
                    <div class="container">
                        <div class="nk-header-wrap">
                            ...
                            <div class="nk-header-brand d-xl-none"><a href="index.html" class="logo-link"><img
                                        ...
                                        src="images/logo-dark.png"></a></div>
                            
                            <div class="nk-header-tools">
                                <ul class="nk-quick-nav">

                               
                                    <li class="dropdown user-dropdown"><a href="index.html#"
                                            class="dropdown-toggle me-n1" data-bs-toggle="dropdown">
                                            <div class="user-toggle">
                                                <div class="user-avatar sm"><em class="icon ni ni-user-alt"></em></div>
                                                <div class="user-info d-none d-xl-block">
                                                    <div class="user-name dropdown-indicator">Afonime Royal</div>
                                                </div>
                                            </div>
                                        </a>
